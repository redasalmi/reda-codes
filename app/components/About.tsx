        ...
        <div className="about-me">
          <div className="about-info">
            <p>
              ...
              learning. By the end of 2019 I decided to go serious and seek a
              full time job as a web developer and got it(while dumping
              electrical engineering in which I hold a master&apos;s degree 😅),
              since then I became a full time web developer. My interests are
              programming 👨‍💻 and gaming 🕹️.
            </p>
          </div>
